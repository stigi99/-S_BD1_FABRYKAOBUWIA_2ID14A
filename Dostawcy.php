					...
					<div class="col-sm-6 col-md-9 offset-md-1">
						...
						<?php
							...
							<table>
							 <table id="myTable2">
								<tr class="header">
    							<th style="width:60%;" onclick="sortTable(0)">ID_dostawcy&nbsp</th>
    							<th style="width:40%;" onclick="sortTable(1)">Cena&nbsp</th>
								<th style="width:40%;" onclick="sortTable(2)">Nazwa&nbsp</th>
								<th style="width:40%;" onclick="sortTable(3)">NIP&nbsp</th>
							...
							while($row = mysqli_fetch_assoc($result)) {
								echo "<tr><td>".$row["ID_dostawcy"]."</td><td>".$row["Cena"]."</td><td>".$row["Nazwa"]."</td><td>"
								.$row["NIP"]."</td><td>"."</tr>";
							}
							} else {
							echo "0 results";
