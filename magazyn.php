					...
					<div class="col-sm-6 col-md-9 offset-md-1">
						...
						<?php
							...
							<table>
							 <table id="myTable2">
								<tr class="header">
    							<th style="width:60%;" onclick="sortTable(0)">ID_magazynu&nbsp</th>
    							<th style="width:40%;" onclick="sortTable(1)">ID_produktu&nbsp</th>
								<th style="width:40%;" onclick="sortTable(2)">Powierzchnia&nbsp</th>
								<th style="width:40%;" onclick="sortTable(3)">Liczba_sztuk&nbsp</th>
							...
							while($row = mysqli_fetch_assoc($result)) {
								echo "<tr><td>".$row["ID_magazynu"]."</td><td>".$row["ID_produktu"]."</td><td>".$row["Powieszchnia"]."</td><td>"
								.$row["Liczba_sztuk"]."</td><td>"."</tr>";
							}
							} else {
							echo "0 results";
							}
